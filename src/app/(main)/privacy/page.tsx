 ...
 *
 * Kullanıcıların kişisel verilerinin nasıl toplandığını, kullanıldığını
 * ve korunduğunu açıklayan yasal bilgilendirme sayfası.
 * KVKK (Kişisel Verilerin Korunması Kanunu) uyumluluk gereksinimlerini karşılar.
 */
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-3xl mx-auto bg-white text-gray-800 rounded-xl shadow-sm p-8">
        ...
        {/* ✅ Bölüm 2: Verilerin Kullanım Amaçları */}
        ...
        <p>
          ...
          Taleplerinizi iletişim formu veya {/* İletişim e-posta linki */}
          <a
