...
// Kargo ve teslimat yöntemleri verileri
export const shippingMethods: ShippingMethod[] = [
  {
    ...
    freeShippingThreshold: 299, // 299 TL ve üzeri ücretsiz kargo
  },
  {
    id: 'express',
    name: 'Express Kargo',
    ...
    // Express kargo için ücretsiz kargo eşiği yok
  },
  {
    id: 'free',
    name: 'Ücretsiz Kargo',
    description: '299 TL ve üzeri alışverişlerde',
    price: 0, // Ücretsiz kargo
    deliveryTime: '3-5 iş günü',
    freeShippingThreshold: 299, // Ücretsiz kargo eşiği
  },
];
...
export const returnPolicies: ReturnPolicy[] = [
  {
    ...
    duration: 14, // 14 gün iade süresi
    conditions: [
  ...
  },
  {
    ...
    duration: 30, // 30 gün değişim süresi
    conditions: [
